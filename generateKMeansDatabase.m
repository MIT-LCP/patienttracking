...
for nave=1:NAVE
    ...
    column_names={'pid','tm','lact_val','lact_dx','lact_var','map_val','map_dx','map_var', ...
        'hr_val','hr_dx','hr_var','urine_val','urine_dx','urine_var','weight_val',...
        'weight_dx','weight_var','pressor_val','pressor_dx','pressor_var','age'};
    Nc=length(column_names);
    lact_db=zeros(0,Nc);
    feature=zeros(0,Nc);
    addVariance=0;
    raw_lact_measurements=[];
