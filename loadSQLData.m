...
header={'SUBJECT_ID','ICUSTAY_ADMIT_AGE','GENDER','ICUSTAY_FIRST_CAREUNIT','CODES','IABP','CABG',...
    'IABP_DISCHARGE','CABG_DISCHARGE','LVAD','RVAD','CONGESTIVE_HEART_FAILURE','CARDIAC_ARRHYTHMIAS',...
    'VALVULAR_DISEASE','AIDS','ALCOHOL_ABUSE','BLOOD_LOSS_ANEMIA','CHRONIC_PULMONARY','COAGULOPATHY',...
    'DEFICIENCY_ANEMIAS','DEPRESSION','DIABETES_COMPLICATED','DIABETES_UNCOMPLICATED','DRUG_ABUSE',...
    'FLUID_ELECTROLYTE','HYPERTENSION','HYPOTHYROIDISM','LIVER_DISEASE','LYMPHOMA','METASTATIC_CANCER',...
    'OBESITY','OTHER_NEUROLOGICAL','PARALYSIS','PEPTIC_ULCER','PERIPHERAL_VASCULAR','PSYCHOSES',...
    'PULMONARY_CIRCULATION','RENAL_FAILURE','RHEUMATOID_ARTHRITIS','SOLID_TUMOR','WEIGHT_LOSS'};
...
remove_ind=((IABP==1)+(CABG==1)+(LVAD==1)+(RVAD==1)) > 0;
...
%Elimate patients from commorbidity columns
